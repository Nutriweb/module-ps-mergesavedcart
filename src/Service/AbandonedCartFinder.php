...
class AbandonedCartFinder
{
     ...
     * @param int $idAbandonedCart source cart, used only to pull each row's raw cart data (manufacturer, category, reduction...) for the optional GTM item mapping below.
     *
